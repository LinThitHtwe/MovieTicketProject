          ...
          {data && (
            <>
              ...
              {existingSeats.length != 0 ? (
                ...
                >
                  <span className="bg-red-500  animate-pulse absolute -top-3 -right-4 text-xs overflow-hidden font-sans w-4 h-4 rounded-full text-white text-center font-medium">
                    {existingSeats.length}
                  </span>
                </i>
              ) : (
                <i className="fa-solid fa-ellipsis relative cursor-default opacity-0"></i>
              )}
            </>
          )}
