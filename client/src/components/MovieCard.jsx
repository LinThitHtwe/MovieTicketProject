    ...
    <>
      <Link to="/movie/id">
        ...
        >
          ...
          <div className="bg-gray-800 absolute bottom-0 text-sm w-full h-[80px] opacity-0 group-hover:opacity-80 transform translate-y-full group-hover:translate-y-0 transition-all duration-700 ease-in-out">
